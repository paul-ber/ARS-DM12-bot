...
class BAACLoader:
    ...
    def load_year(self, year):
        ...
        # 3. Agrégation Usagers (avec gestion colonnes manquantes)
        ...
        # 4. Agrégation Véhicules (avec gestion colonnes manquantes)
        ...
        # 5. Fusions (LEFT pour conserver tous les accidents de carac)
        ...
        # 7. Coordonnées (nettoie mais NE FILTRE PAS !)
        ...
        # 🔥 PAS DE FILTRE GPS ! On garde TOUT
        # On met juste à None les coordonnées aberrantes (0,0 ou hors monde)
    ...
    def load_all_years(self, n_jobs=10):
